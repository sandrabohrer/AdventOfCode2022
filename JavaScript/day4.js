...
function returnSectionAssignmentCheck() {
...
console.log('The number of assignment pairs where one range fully contains the other is: ' + returnSectionAssignmentCheck());